...
const ContentTypeNames = {
  ...
  HPApprovalLetter: {
    ...
    access: {
      ...
      [Pages.assignment]: [D.CHS, D.GMI, D.GMD, D.CHA, D.WBY, D.WMS],
    },
    required: [],
  ...
  NZIRDNumber: {
    ...
    lifecycle: Lifecycles.Provider,
     access: {
      // [Pages.provider]: [D.GMI, D.GMD],
    }, // not visible in UI for GMI/GMD provider page — confirm with team
    required: [],
  ...
  DeferredCompensationAgreement: {
    // TODO: confirm code with team
    // NOTE: not visible to default CHS user (dmsapitestuserchs@chghealthcare.com)
    // — requires elevated permissions. Confirm access model with team before adding to access map.
    displayName: 'Deferred Compensation Agreement',
    code: null,
    category: Categories.FinancialTax,
    lifecycle: Lifecycles.Provider,
    access: {
      // [Pages.provider]: [D.CHS],
    },
    required: [],
    optional: [],
    vqVisible: true,
  ...
  ClientW9: {
  displayName: 'Client W9',
  code:        null, // confirm with team
  category:    Categories.FinancialTax,
  lifecycle:   Lifecycles.Default,
  access: {
    // [Pages.client]: [D.ALL], //TODO not visible to default CHS user — requires elevated permissions
  },
  required:  [],
  optional:  [],
  vqVisible: false,
